...
namespace as
{
	...
	namespace vk
	{
		...
		void as::vk::init_window(as::window& in_window)
		{
			glfwInit();
		...
		void as::vk::create_image_resources(as::vk::engine& in_engine)
		{
		...
		void as::vk::init_vulkan(as::vk::engine& in_engine, as::window& in_window)
		{
		...
		void as::vk::draw_frame(as::vk::engine& in_engine, as::window in_window)
		{
			...
			{
				recreateSwapChain(in_engine, in_window);
				return;
			}
			...
			recordCommandBuffer(in_engine.commandBuffers[in_engine.currentFrame], imageIndex, in_engine);
		...
		void as::vk::start_main_loop(as::vk::engine& in_engine, as::window& in_window)
		{
		...
		void as::vk::cleanupSwapChain(as::vk::engine& in_engine)
		{
		...
		void as::vk::cleanup(as::vk::engine in_engine, as::window in_window)
		{
		...
		void as::vk::recreateSwapChain(as::vk::engine in_engine, as::window in_window)
		{
			...
			as::vk::create_swap_chain(&in_engine.swapchain_.swapchainKHR, &in_engine.swapchain_.images, &in_engine.swapchain_.image_format, &in_engine.swapchain_.extent, &in_engine.device, &physicalDevice, &surface, window);
			...
			as::vk::create_frame_buffers(in_engine.swapchain_.framebuffers, in_engine.device, in_engine.swapchain_.image_views, color_image.view, depth_image.view, render_pass, in_engine.swapchain_.extent);
		}

		void as::vk::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex, as::vk::engine in_engine)
		{
			...
			vkCmdBindDescriptorSets(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, graphics_pipeline.layout, 0, 1, &in_engine.descriptorSets[in_engine.currentFrame], 0, nullptr);
		...
		void as::vk::updateUniformBuffer(uint32_t currentImage, as::vk::engine in_engine)
		{
