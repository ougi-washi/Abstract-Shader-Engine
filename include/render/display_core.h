...
namespace as
{
	bool create_display_handle(const bool& is_raw_display, const u16& width, const u16& height, as::input_handle& input, as::display_handle& display_handle);
	...
	bool process_input(const as::display_handle& display_handle, as::input_handle& input_handle);
