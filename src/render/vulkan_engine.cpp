...
void as::vk::framebufferResizeCallback(GLFWwindow* window, int width, int height)
{
	framebufferResized = true;
}

void as::vk::initWindow()
{
	glfwInit();
...
void as::vk::create_image_resources()
{
...
void as::vk::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
...
void as::vk::updateUniformBuffer(uint32_t currentImage)
{
