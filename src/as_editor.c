...
void as_editor_set_default_scene()
{
	...
	as_object* object3 = as_object_create(shape_cube, gray_shader);
	as_object* object4 = as_object_create(shape_cube, gray_shader);
	as_object* object5 = as_object_create(shape_cube, gray_shader);
	as_object_set_translation(object3, AS_VEC_PTR(as_vec3, 0., 0., -5.));
	as_object_set_translation(object4, AS_VEC_PTR(as_vec3, 0., 3., -5.));
