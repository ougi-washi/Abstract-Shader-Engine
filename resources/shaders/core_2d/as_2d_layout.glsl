...
#define AS_MAX_GPU_SCREEN_OBJECT_CUSTOM_DATA_SIZE 16 // has to match the cpu side
...
layout(binding = 0) uniform uniform_buffer_screen_object 
{
	...
	// [2][...]	empty
	// [3][...]	empty
	int custom_info[AS_MAX_GPU_SCREEN_OBJECT_CUSTOM_INFO_SIZE];
	int custom_data[AS_MAX_GPU_SCREEN_OBJECT_CUSTOM_DATA_SIZE];
} ubo; 
